...
class SettingWindow(QWidget):
	def __init__(self, go_to_menu_callback):
		...
		form_widget = QWidget()
		form_widget.setObjectName("layout_form")
		...
		self.new_by_day_spin.setFocusPolicy(Qt.FocusPolicy.NoFocus)
		...
		self.lat_spin.setFocusPolicy(Qt.FocusPolicy.NoFocus)
		...
		self.new_review_random_combo.setFocusPolicy(Qt.FocusPolicy.NoFocus)
		...
		self.new_select_random_combo.setFocusPolicy(Qt.FocusPolicy.NoFocus)
